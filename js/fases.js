...
export const FASES = [
  ...
  },
  {
    ...
    secaoDossie: "imagens",
    campoDistintivo: "notas",
    notaSecao: "A nota e a checagem de continuidade marcam as mesmas imagens da fase 13, na mesma seção — com formato incompatível ao da fase 13 (\"itens\" vs \"notas\"/\"ordem\"/\"continuidades\"), ver campoDistintivo e a nota da fase 13. Herda a mesma limitação de sessão: só roda na aba onde a fase 13 gerou as imagens (elas nunca vão pro dossiê). Usa sempre a variação-âncora de cada passo — a mesma que sustenta a cadeia da fase 13 — como a imagem avaliada; ainda não existe uma tela pra escolher outra das 3 variações manualmente (lacuna registrada no README). O gate da fase é o teste de ordem embaralhada: as imagens vão pro modelo com rótulos de letra, sem nenhum número real, e o código (não o modelo) compara a ordem sugerida contra a ordem verdadeira. Reusa GEMINI_MODEL da fase 06 (o modelo de visão, não o de imagem da fase 13) — verificação cega é leitura, não geração.",
  },
  {
    numero: "15",
